        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form role="form" class="form-horizontal" method="POST" action="<?php echo U('business/verify/first/list'); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <select class="form-control" name="audit_status" id="audit_status">
                                    ...
                                    <option value="rfe">补件中</option>
                                    <option value="rfed">补件完成</option>
                                    <option value="approved">通过</option>
                                    <option value="issued">已放款</option>
                                </select>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <input type="button" class="btn btn-danger btn-block" id="reject-all" value="全部拒绝"/>
                            </div>                            
                        </div>
                    </form>
                    <div>
                        <table class="table table-striped table-bordered table-hover table-condensed" id="dataTables-example">
                            ...
                            <tbody>
                               <?php if(isset($orderList) && is_array($orderList)):?>
                                ...
                                <tr class="odd gradeX">
                                    <td><input type="checkbox" name="orderid" value="<?php echo $order['id'];?>"/></td>
                                    ...
                                    <td>
                                        <a href="<?php echo U('business/verify/first/detail', array('id' => $order['id']));?>">
