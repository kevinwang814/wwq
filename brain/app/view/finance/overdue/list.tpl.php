    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="page-header">
                ...
                <a href="/finance/overdue/list.html">
                    <span>列表</span>
                </a>
            </div>
        </div>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form role="form" class="form-horizontal" method="POST" action="<?php echo U('finance/overdue/list'); ?>">
                        <div class="form-group">
                            ...
                            <label class="radio-inline">新凭证:</label>
                            <label class="radio-inline">
                                <input type="radio" name="has_evidence" id="has_evidence_all" value="">全部
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="has_evidence" id="has_evidence_yes" value="1">有
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="has_evidence" id="has_evidence_no" value="0">无
                            </label>
                        </div>
                        <div class="form-group">
                            ...
                            <tbody>
                               <?php if(isset($billList) && is_array($billList)):?>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        <?php echo round($bill['principal'] + $bill['interest'] - $bill['repaid_principal'] - $bill['repaid_interest'],2);?>
                                    </td>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        var has_evidence = '<?php echo requestv('has_evidence','')?>';
        $("input[name='has_evidence'][value='" + has_evidence + "']").attr("checked",'checked');
    });
</script>
<?php $this->_endblock();