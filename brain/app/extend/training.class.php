<?php
    ...
    class Extend_Training{
         ...
         */
        public function saveTrainingImage($fileHash, $element, &$message) {
            ...
            $imgDir = C('img_dir');
            $dir_original = $imgDir . "/training/original/" ;
            $dir_width_200 = $imgDir . "/training/width_200/";
