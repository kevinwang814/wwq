<?php
    ...
    class Extend_Goods_Image{
         ...
         */
        public function saveImage($fileHash, $element, &$message) {
            ...
            $imgDir = C('img_dir');
            $dir_original = $imgDir . "/goods/original" ;
            $dir_width_200 = $imgDir . "/goods/width_200";
