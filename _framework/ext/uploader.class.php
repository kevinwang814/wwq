...
class Ext_Uploader
{
    ...
    function __construct()
    {
        ...
        foreach ($_FILES as $field_name => $postinfo)
        {
            ...
            else
            {
                ...
                {
                    self::$_files[$field_name] = new Ext_Uploader_File($postinfo, $field_name);
                }
            }
        }
    }
     ...
     *
     * @return Ext_Uploader_File 指定名字对应的文件对象
     */
    function file($name)
    {
...
/**
 * Ext_Uploader_File 类封装一个上传的文件
 */
class Ext_Uploader_File
{
    /**
     * 上传文件信息
     *
    ...
    function isValid($allowed_types = null, $max_size = null)
    {
        ...
        if ($allowed_types)
        {
            $allowed_types = $this->normalize($allowed_types);
            ...
            $extnames = $this->normalize($filename, '.');
