...
class Ext_Xxtea
{
    ...
    public static function encrypt($str, $key='xao53nbs9cke06v')
    {
        if ($str == "") {
            return "";
        }
        ...
        return self::safe_b64encode(self::long2str($v, false));
    }

    static function decrypt($str, $key='xao53nbs9cke06v')
    {
        if ($str == "") {
            return "";
        }
        $str = self::safe_b64decode($str);
