...
class Ext_ajaxpager
{
    ...
    public function __construct($cpage, $totaldata, $pagenum=10, $opage=9)
    {
        $this->cpage = $cpage;
    ...
    {
        return "getVideos.changePage({$tpage})";
    }
    ...
    private function f3()
    {
        ...
        if($this->cpage > 1)
        {
            $bp = $this->url($this->cpage - 1);
            $fp = $this->url(1);
            $_linkstr .= "<li><a href=\"javascript:;\" onclick=\"".$fp."\">首页</a></li> \n";
            $_linkstr .= "<li><a href=\"javascript:;\" onclick=\"".$bp."\">上一页</a></li> \n";
        }else
        {
            $_linkstr .= "<li class=\"disabled\"><a href=\"javascript:;\">首页</a></li> \n";
            $_linkstr .= "<li class=\"disabled\"><a href=\"javascript:;\">上一页</a></li> \n";
        }
        ...
        {
            if($this->cpage != $i)
                $_linkstr .= "<li><a href=\"javascript:;\" onclick=\"{$this->url($i)}\">" . $i . "</a></li> \n";
            else
                $_linkstr .= "<li class=\"active\"><a href=\"javascript:;\">{$i}</a></li> \n";
        }

        //尾页
        if($this->cpage == $this->totalpage || $this->totalpage == 0)
        {
            $_linkstr .= "<li class=\"disabled\"><a href=\"javascript:;\">下一页</a></li> \n";
            $_linkstr .= "<li class=\"disabled\"><a href=\"javascript:;\">尾页</a></li> \n";
        }else
        {
            $np = $this->url($this->cpage + 1);
            $ep = $this->url($this->totalpage);
            $_linkstr .= "<li><a href=\"javascript:;\" onclick=\"". $np ."\">下一页</a></li> \n";
            $_linkstr .= "<li><a href=\"javascript:;\" onclick=\"". $ep ."\">尾页</a></li> \n";
        }
        $_linkstr .= "</ul>\n"; //end div
        return $_linkstr;
    }
