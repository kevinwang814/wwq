...
class Ext_Captcha
{
     ...
     *
     */
    protected $_sessionValueKey = 'captcha_value';
    protected $_sessionTtlKey = 'captcha_ttl';
    ...
    {
        $this->_font = FW_PATH . '/misc/font/times.ttf';
        $this->_init($config);
    }
    ...
    {
        $expireTime = sessionv($this->_sessionTtlKey);
        $captchaCode = sessionv($this->_sessionValueKey);
