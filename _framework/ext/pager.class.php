...
class Ext_Pager
{
    ...
    private function f3()
    {
        ...
        if($this->cpage > 1)
        {
            $_linkstr .= "<li><a href=\"{$this->url(1)}\">首页</a></li> \n";
            $_linkstr .= "<li><a href=\"" . $this->url($this->cpage - 1) . "\">上一页</a></li> \n";
        }else
        {
            $_linkstr .= "<li class=\"disabled\"><a>首页</a></li>" . " \n";
            $_linkstr .= "<li class=\"disabled\"><a>上一页</a></li>" . " \n";
        }
        ...
        {
            if($this->cpage != $i)
                $_linkstr .= "<li><a href=\"{$this->url($i)}\" class=\"number\">" . $i . "</a></li> \n";
            else
                $_linkstr .= "<li class=\"active\"><a class=\"number current\">{$i}</a></li> \n";
        }

        //尾页
        if($this->cpage == $this->totalpage || $this->totalpage == 0)
        {
            $_linkstr .= "<li class=\"disabled\"><a>下一页</a></li>" . " \n";
            $_linkstr .= "<li class=\"disabled\"><a>尾页</a></li>" . " \n";
        }else
        {
            $_linkstr .= "<li><a href=\"" . $this->url($this->cpage + 1) . "\">下一页</a></li> \n";
            $_linkstr .= "<li><a href=\"" . $this->url($this->totalpage) . "\">尾页</a></li> \n";
        }
        $_linkstr .= "</ul>\n"; //end div
        return $_linkstr;
    }
